...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GoogleUtilities-iOS11.2/GoogleUtilities.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PromiseKit-iOS11.2/PromiseKit.framework"
